...
ADMIN_MENU_CATALOG = [
    ...
    {"key": "transactions",    "label": "Transactions",     "group": "Sales & Billing", "default_roles": ["admin", "finance", "sales"]},
    ...
    {"key": "sla",             "label": "SLA & Incidents",   "group": "Operations",     "default_roles": ["admin", "support", "finance", "sales"]},
